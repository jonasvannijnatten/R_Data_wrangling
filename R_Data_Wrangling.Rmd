...
1. [Dataset aanmaken](#Data_aanmaken)    

2. [Data inspecteren](#Data_inspecteren)  
  2.1 [Foutieve data opsporen](#Foutieve_data)  
    2.1.1 [Dubbele ingevoerde data](#Dubbele_data)  
    2.1.2 [Extreme of foutieve waardes](#Extreme_data)  
...
<a name="Data_aanmaken"></a> <div align="right"><a href='#inhoud'>inhoud</a></div>
### Dataset aanmaken
```{r, echo = FALSE}
set.seed(06)
nrofsubs  = 4
...
<a name="Data_inspecteren"></a>  <div align="right"><a href='#inhoud'>inhoud</a></div>
### Data inspecteren 
In dit deel wordt onderstaande dataset, genaamd **badData** gebruikt om voorbeelden te geven.  
<details><summary><span style="color:dodgerBlue">Toon code om **badData** te genereren </span></summary>
```{r, echo=TRUE}
badData = data.long
badData[c(4,7),3] = NA
badData[4,2] = NA
...
<details><summary><span style="color:dodgerBlue">Toon dataset **badData**</span></summary>
```{r, echo=FALSE}
print(badData, digits = 3, print.gap = 5, row.names = TRUE)
```
</details>
\subsection{Foutieve data opsporen} 
<a name="Foutieve_data"></a>  <div align="right"><a href='#inhoud'>inhoud</a></div>
...
<a name="Dubbele_data"></a>  <div align="right"><a href='#inhoud'>inhoud</a></div>
...
<a name="Extreme_data"></a>  <div align="right"><a href='#inhoud'>inhoud</a></div>
...
<a name="Data_types"></a>  <div align="right"><a href='#inhoud'>inhoud</a></div>
...
<a name="Data_opschonen"></a>  <div align="right"><a href='#inhoud'>inhoud</a></div>
## Data opschonen
...
<a name="Datastructuren"></a><div align="right"><a href='#inhoud'>inhoud</a></div>
...
<a name="wide2long"></a> <div align="right"><a href='#inhoud'>inhoud</a></div>
### Van wide naar long 
\newpage
...
<a name="long2wide"></a> <div align="right"><a href='#inhoud'>inhoud</a></div>
### Van long naar wide 
