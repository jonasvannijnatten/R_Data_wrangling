...
Er bestaan vele manieren om ontbrekende en foutieve data op te sporen in je dataset. In deze handleiding zullen we het gebruik van de  volgende functies bespreken:
```{r, eval=FALSE}
is.na()
is.nan()
is.null()
...
In R worden ontbrekende waardes weergegeven als *NaN* (Not A Number), *NA* (Not Available) of *NULL*. Om deze op te sporen kun je de functies *is.na(), is.nan(), is.null()* gebruiken. In dit voorbeeld staan er missende waardes als NA in de dataset:
```{r, echo=TRUE}
